...
# UDF
User Defined Function (UDF) di ksqlDB adalah fungsi yang ditulis oleh pengguna untuk melakukan operasi khusus yang tidak tersedia dalam fungsi bawaan ksqlDB. UDF memungkinkan pengguna untuk memperluas kemampuan ksqlDB dengan menambahkan logika khusus yang ditulis dalam Java.
