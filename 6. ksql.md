...
6. start service ksql lalu coba terlebih dahulu dengan perintah SHOW FUNCTION; hal ini berguna untuk melihat keseluruhan function yang dapat digunakan di ksql termasuk function custom yang sudah dibuat. berikut adalah hasilnya:
...
9. running query push dengan perintah SELECT * FROM reverse EMIT CHANGES; untuk mengecek secara update isi dari stream reverse sebelum dilakukannya pengisian populasi.
