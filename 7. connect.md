...
8. selanjutnya saya akan menginput data baru ke db dengan query dan melihat apakah kafka topic ikut terupdate saat muncul data baru di database. Berikut querynya:
